...
const mockAreas = [
  {
    ...
    products: [
      { id: "p1",  name: "24 Heineken 600ml",          price: 408, discountPercent: 0, category: "Cervejas",   obs: "Caixas lacradas, entregues geladas no início do evento.",                           showObs: true },
      { id: "p2",  name: "24 Amstel 600ml",             price: 360, discountPercent: 0, category: "Cervejas",   obs: "Caixas lacradas, entregues geladas no início do evento.",                           showObs: true },
      { id: "p3",  name: "12 Antarctica Litão",         price: 192, discountPercent: 0, category: "Cervejas",   obs: "Garrafas 1L, ideais para grupos grandes. Entregues geladas.",                      showObs: true },
      { id: "p4",  name: "24 Antarctica 600ml",         price: 312, discountPercent: 0, category: "Cervejas",   obs: "Caixas lacradas, entregues geladas no início do evento.",                           showObs: true },
      { id: "p5",  name: "Whisky Jack Daniel's 1L",     price: 220, discountPercent: 0, category: "Destilados", obs: "Garrafa 1L + gelo e copos fornecidos.",                                             showObs: true },
      { id: "p6",  name: "Vodka Absolut 1L",            price: 180, discountPercent: 0, category: "Destilados", obs: "Garrafa 1L + gelo e copos fornecidos.",                                             showObs: true },
      { id: "p7",  name: "Gin Beefeater 1L",            price: 190, discountPercent: 0, category: "Destilados", obs: "Garrafa 1L + 4 tônicas, limão e gelo.",                                             showObs: true },
      { id: "p8",  name: "Pack Refrigerante (12 un)",   price:  96, discountPercent: 0, category: "Sem Álcool", obs: "Latas variadas: Coca-Cola, Guaraná Antarctica e Sprite.",                           showObs: true },
      { id: "p9",  name: "Pack de Água (12 un)",        price:  60, discountPercent: 0, category: "Sem Álcool", obs: "Garrafas 500ml, geladas.",                                                          showObs: true },
      { id: "p10", name: "Combo Churrasco Completo",    price: 380, discountPercent: 0, category: "Carnes",     obs: "Picanha 1kg + costela 1kg + linguiça 500g + frango 1kg, tudo temperado.",           showObs: true },
      { id: "p11", name: "Picanha 2kg",                 price: 320, discountPercent: 0, category: "Carnes",     obs: "Picanha temperada, pronta para grelhar.",                                            showObs: true },
      { id: "p12", name: "Frango Temperado 2kg",        price: 160, discountPercent: 0, category: "Carnes",     obs: "Coxa e sobrecoxa marinadas com tempero da casa.",                                   showObs: true },
      { id: "p13", name: "Churrasqueiro",               price: 200, discountPercent: 0, category: "Serviços",   obs: "Profissional exclusivo para o preparo e corte das carnes durante o evento.",        showObs: true },
      { id: "p14", name: "Atendente Particular",        price: 150, discountPercent: 0, category: "Serviços",   obs: "Garçom dedicado à sua área durante todo o evento.",                                 showObs: true },
    ]
  },
  {
    id: "2",
